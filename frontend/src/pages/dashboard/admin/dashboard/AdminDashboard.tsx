          ...
          <>
            <div className={styles.statsGrid}>
              ...
              <StatCard
                ...
                label={t("admin.dashboard.stats.open")}
                delay={75}
                duration={2000}
              />
              <StatCard
                value={stats?.totalTeams ?? 0}
                label={t("admin.dashboard.stats.teams")}
                delay={0}
                duration={2000}
              />
              <StatCard
            ...
            <div className={styles.actionsSection}>
              ...
              <div
                className={`${styles.actionsGrid} ${isReady ? styles.animate : ""}`}
              >
                <button
                ...
                >
                  ...
                  <span className={styles.actionLabel}>
                    {t("admin.dashboard.quick.tournaments")}
                  </span>
                </button>
                <button
                  className={styles.actionCard}
                ...
                >
                  ...
                  <span className={styles.actionLabel}>
                    {t("admin.dashboard.quick.submissions")}
                  </span>
                </button>
              </div>
            </div>
