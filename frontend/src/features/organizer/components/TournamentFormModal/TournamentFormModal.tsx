...
import { z } from "zod";
import { useUpdateTournament } from "@/features/organizer/hooks/useTournamentMutations";
        ...
        <form className={styles.form} onSubmit={handleSubmit(onSubmit)} autoComplete="off">
          ...
          <div className={styles.row}>
            <div className={styles.field}>
              ...
              <input
                type="datetime-local"
                className={`${styles.input} ${errors.registration_start_date ? styles.inputError : ""}`}
                {...register("registration_start_date")}
              />
              {errors.registration_start_date && (
                <span className={styles.fieldError}>{errors.registration_start_date.message}</span>
              )}
            </div>
            ...
            <div className={styles.field}>
              ...
              <input
                type="datetime-local"
                className={`${styles.input} ${errors.registration_end_date ? styles.inputError : ""}`}
                {...register("registration_end_date")}
              />
              {errors.registration_end_date && (
                <span className={styles.fieldError}>{errors.registration_end_date.message}</span>
              )}
            </div>
          </div>
          ...
          <div className={styles.row}>
            ...
            <div className={styles.field}>
              ...
              <input
                type="number"
                className={`${styles.input} ${errors.min_user_count ? styles.inputError : ""}`}
            ...
            <div className={styles.field}>
              ...
              <input
                type="number"
                className={`${styles.input} ${errors.max_user_count ? styles.inputError : ""}`}
          ...
          <div className={styles.actions}>
            ...
            <button type="submit" className={styles.btnPrimary} disabled={updateMutation.isPending}>
              {updateMutation.isPending ? "Saving..." : isEdit ? "Update" : "Create"}
            </button>
          </div>
        </form>
      </div>
